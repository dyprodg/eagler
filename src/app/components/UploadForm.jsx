            ...
            <div className="flex gap-4 items-start pb-4 w-full">
                <div className="rounded-full h-12 w-12 overflow-hidden relative">
                    <Image 
                        ...
                        alt={/*user.name  || */ "user profile name"}
                        priority={true}
                        fill={true}
                    />
                </div>
                ...
                <div className="flex flex-col gap-2 w-full">
                    ...
                    <label className="flex">
                        <svg
                            className="w-5 h-5 hover:cursor-pointer hover:scale-110 transform-gpu active:scale-75 transition-all text-neutral-500"
