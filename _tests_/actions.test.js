// actions.test.js
import { deleteAccount, getSignedURL, getLatestPosts, getUserPosts, deletePost } from '@/app/actions';
...
describe('actions', () => {
  ...
  it('should delete post', async () => {
    const session = { user: { id: '1' } };
    const post = { id: '1' };
    prisma.post.findUnique.mockResolvedValue({ userId: '1', imageUrl: 'http://example.com/image.jpeg' });
